...
#Directory_image= '/content/gdrive/MyDrive/Colab Notebooks/first trial/basics_for_infrared_detection/dataset/LSOTB-TIR_TrainingData_part5/TIR_training_004/TIR_training_004_ann
Directory_image = os.getcwd()

for i, folder in enumerate(os.listdir(Directory_image)):
    
    for count, filename in enumerate(glob(f'{folder}/*.xml')):
